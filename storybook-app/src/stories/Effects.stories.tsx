...
const wrap: React.CSSProperties = {
  ...
  // sem background — deixa o fundo padrão aparecer
};
  ...
  render: () => (
    <div style={wrap}>
      ...
      <p style={{ fontSize: 13, color: 'var(--color-text-secondary)', lineHeight: 1.7, marginBottom: 24, maxWidth: 520 }}>
        ...
        Usado em sidebar, cards, inputs e botões secundários. Nunca use em container com <code style={{ fontFamily: 'var(--font-mono)', fontSize: 11 }}>overflow: hidden</code>.
      </p>
